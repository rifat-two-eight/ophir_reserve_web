...
export default function AdminProfilePage() {
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    if (!currentPassword) {
      showNotification("Please provide your current master password.", "error");
      return;
    }
  ...
  return (
    <div className="space-y-7 w-full max-w-7xl mx-auto pb-10">
      ...
      {toast && (
        <div
          className={`fixed top-6 right-6 z-50 flex items-center gap-3 px-5 py-4 border rounded-sm shadow-2xl transition-all duration-300 font-sans ${
            toast.type === "success"
      ...
      {/* Page Header */}
      <div>
        <h2 className="text-2xl font-semibold text-[#F2CA50] font-serif tracking-wide">Master Profile</h2>
        ...
        <div className="bg-[#161616] border border-white/6 p-8 rounded-sm flex flex-col items-center text-center justify-between">
          ...
          <div className="w-full pt-8 border-t border-white/5 mt-8 space-y-3.5 text-left text-xs font-sans text-stone-500">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-[#F2CA50] font-semibold uppercase tracking-wider">Tier 1 Master</span>
            </div>
            <div className="flex justify-between">
      ...
      <div className="bg-[#161616] border border-white/6 p-8 rounded-sm w-full">
        <div className="mb-6">
          <h3 className="text-base font-semibold text-stone-200 font-serif tracking-wide">Master Credentials Configuration</h3>
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-6">
          ...
          <div className="pt-2 flex justify-end">
            ...
            >
              {isUpdatingPassword ? "Updating Password Master..." : "Update Master Password"}
            </button>
          </div>
        </form>
      </div>
