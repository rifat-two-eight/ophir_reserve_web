  ...
  useEffect(() => {
    ...
    const loadUnreadCount = () => {
      ...
      if (savedCount !== null) {
        ...
        setUnreadCount(3); // Default unread notifications is 3
      }
    };
    ...
    window.addEventListener("admin_notifications_update", handleNotificationsUpdate);
    ...
    return () => {
      ...
      window.removeEventListener("admin_notifications_update", handleNotificationsUpdate);
    ...
    <header className="h-[72px] flex-shrink-0 flex items-center gap-5 px-8 bg-[#111111] border-b border-white/5">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs text-stone-500 font-sans tracking-wide truncate">
          Overseeing the legacy of curated exceptionalism.
        </p>
      </div>
